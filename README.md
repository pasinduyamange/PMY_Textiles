...
5. List Foods
    1. Create Allitems model
    2. Create data.ts
       1. Add sample foods
    3. Add images to assets
    4. Create Allitems service
...
6. Search
   1. Add method to Allitems service
   2. Add search route
...
8. Allitems Page
   ...
   2. Generate Allitems Page component
      1. Add Route
      2. Add ts
      3. Add html
      4. Add css
...
9. Cart Page
   ...
   4. Add to Cart Button in Allitems Page
